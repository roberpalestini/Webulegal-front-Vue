  ...
  <div class="container">
    <div class="row justify-content-center">
      ...
      <div class="col-md-5 text-center" style="font-size:16px;margin-top:20px;margin-bottom:20px;">
        Hacé más eficiente tu trabajo legal
      </div>
      <div class="col-md-12"></div>
      ...
      <div class="col-md-5" style="margin-top:20px;margin-bottom:20px;">
        <form @submit.prevent="submit()">
          ...
          <div class="form-group text-center">
            <input type="text" class="form-control" placeholder="E-Mail" v-model="data.email" style=" background: transparent !important;
    ...
    width:98% !important; margin:0" />
          ...
          <div class="form-group text-center">
            <input type="password" class="form-control" placeholder="Contraseña" v-model="data.password" style=" background: transparent !important;
    border: 1px solid #b8b8b8 !important;
    border-radius: 0 !important;
    height: 45px !important;
    max-height: 45px !important;
    min-height: 45px !important;
     ...
     " />
          ...
          <div class="form-group" style="margin-top:20px;margin-bottom:20px;">
            <p>Al ingresar aceptás los <a href='assets/TÉRMINOS-Y-CONDICIONES-GENERALES-WEBU.pdf'
                target="_blank">términos y
                condiciones</a> y <a href="assets/Politica-de-Privacidad-Webu.pdf" target="_blank">política de
                privacidad</a> de la
              página</p>
          </div>
    ...
    /* background: rgb(59, 89, 152); */" sdk-locale="ar_AR" :slot="{ login: 'test' }">
      ...
      <div class="col-md-5">
        <div class="form-group text-center" style="margin-top:20px;margin-bottom:20px;">
          ¿No tenes cuenta? <a href="#" @click.prevent="goToRegister()">Registrarse</a>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      endpoint: window.ENDPOINT + '/users/login',
