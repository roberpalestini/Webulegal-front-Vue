            ...
            ">
                ...
                ">
                            <div class="row justify-content-center">
                                <div class="row justify-content-center">
                                    <div class="col-12" style="margin-top: -50px; padding-bottom: 30px">
...
editor_view = false;
                  ...
                  ">
                                <div id="editControls" style="text-align: left; padding: 5px">
                                    ...
                                    <div class="btn-group">
                                        <select class="btn" v-model="temp.editSize"
                                            @change="actionTeste($event, 'size')">
    ...
    <div class="modal fade" id="staticBackdrop4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-sm" style="width: 300px">
            <div class="modal-content" style="border-radius: 10px; border: none; width: 300px">
...
export default {
    ...
    methods: {
        ...
        removefield(index) {
            ...
            element.outerHTML = fieldData.base
            element.classList.remove("text-map-hover");
            this.fields.splice(index, 1);
